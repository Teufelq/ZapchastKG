package com.example.zapchastkg110.presenation.components.consumer.main
...
@Composable
fun MainConsumerDesign(navHostController: NavHostController) {
    ...
    horizontalAlignment = Alignment.CenterHorizontally
        ...
        BaseTopBar(Constance.mainScreenName, Purple)
